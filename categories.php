    ...
    <body id="_3" >
        ...
        <div id="content" >
            ...
            <div id="box0">
                <center>
                    <a id="ada" href="#box1" >
                        <div id="algo" class="img" style= "background: url(algorithm.jpg);"  background-size: 100%;>
                            <div id="p" title="Open">Algorithm</div>
                        </div>
                    </a>
                    <a id="cso" href="archi.php">
                        <div id="archi" class="img" style= "background: url(archi.jpg);"  background-size: 100%;>
                            <div id="p" title="Open">Architecture</div>
                        </div>
                    </a>
                    <a id="t" href="ada.php">
                        <div id="toc" class="img"  style= "background: url(automat.jpg);"  background-algorithm>
                            <div id="p" title="Open">Theory of Computation</div>
                        </div>
                    </a>
                </center>
                <center>
                    <a id="db" href="database.php">
                        <div id="database" class="img" style= "background: url(database.jpg);"  background-size: 100%;>
                            <div id="p" title="Open">Database Management</div>
                        </div>
                    </a>
                    <a id="pqt" href="prob.php">
                        <div id="prob" class="img" style= "background: url(prob.jpg);"  background-size: 100%; >
                            <div id="p" title="Open">Probability &amp; Queuing Theory</div>
                        </div>
                    </a>
                    <a id="se" href="software.php">
                        <div id="soft" class="img"  style= "background: url(software.jpg);"  background-size: 100%;>
                    ...
                    <center>
                        ...
                        <div id="qa-block">
                            ...
                            <div class="answer">
                                ...
                                <form id="f<?php echo $nul; ?>" style="margin-bottom: -25px;" action="<?php echo htmlspecialchars( $_SERVER["PHP_SELF"] ); ?>" method="post" enctype="multipart/form-data">
<!--                                    <input type="button" value="Click here to answer." id="ans_b" >-->
                                    <label style="margin-bottom: -25px;"><a id="ans_b<?php echo $nul; ?>" href="#area<?php echo $nul; ?>"><u>Submit your answer</u></a></label>
                                    <br>
                                    <script>
                                        $(function(){
